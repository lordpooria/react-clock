...
var useStyle = /*#__PURE__*/core.makeStyles(function () {
...
var useStyle$1 = /*#__PURE__*/core.makeStyles(function () {
  return core.createStyles({
    mark: {
      position: "absolute",
      top: 0,
...
var useStyle$2 = /*#__PURE__*/core.makeStyles(function () {
  return core.createStyles({
    clockRoot: {
      display: "block",
      position: "relative"
...
function Clock(_ref) {
  ...
  function renderHourHandFn() {
    var angle = value ? dateUtils.getHours(value) * 30 + dateUtils.getMinutes(value) / 2 + dateUtils.getSeconds(value) / 600 : 0;
  ...
  function renderMinuteHandFn() {
    ...
    var angle = value ? dateUtils.getHours(value) * 360 + dateUtils.getMinutes(value) * 6 + dateUtils.getSeconds(value) / 10 : 0;
    return /*#__PURE__*/React.createElement(Hand, {
      angle: angle,
  ...
  function renderSecondHandFn() {
    ...
    var angle = value ? dateUtils.getMinutes(value) * 360 + dateUtils.getSeconds(value) * 6 : 0;
    return /*#__PURE__*/React.createElement(Hand, {
      angle: angle,
