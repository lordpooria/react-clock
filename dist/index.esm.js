...
var Clock = function (_a) {
    ...
    function renderFace() {
        return (React.createElement("div", { className: clsx(clockClasses.face, classes === null || classes === void 0 ? void 0 : classes.clockFace) },
            renderMinuteMarksFn(),
            renderHourMarksFn()));
    }
    ...
    return (React.createElement("time", { className: clsx(clockClasses.clockRoot, className, classes === null || classes === void 0 ? void 0 : classes.root), dateTime: value instanceof Date ? value.toISOString() : value, style: {
            width: size + "px",
            height: size + "px",
