...
var Clock = function (_a) {
    ...
    function renderMinuteMarksFn() {
        ...
        for (var i = 1; i <= 60; i += 1) {
            ...
            if (!isHourMark) {
                minuteMarks.push(React.createElement(Mark, { key: "minute_" + i, angle: i * 6, length: minuteMarksLength, name: "minute", width: size / minuteMarksWidthRatio, classes: classes === null || classes === void 0 ? void 0 : classes.marker }));
            }
        }
        return minuteMarks;
    }
    function renderHourMarksFn() {
        ...
        for (var i = 1; i <= 12; i += 1) {
            hourMarks.push(React.createElement(Mark, { key: "hour_" + i, angle: i * 30, length: hourMarksLength, name: "hour", number: renderNumbers ? i : null, width: size / hourMarksWidthRatio, classes: classes === null || classes === void 0 ? void 0 : classes.marker }));
        }
        return hourMarks;
    }
    function renderFace() {
    ...
    function renderHourHandFn() {
        var angle = value
            ...
            : 0;
        return (React.createElement(Hand, { angle: angle, length: hourHandLength, name: "hour", oppositeLength: hourHandOppositeLength, width: size / hourHandWidthRatio, classes: classes === null || classes === void 0 ? void 0 : classes.handle }));
    }
    function renderMinuteHandFn() {
        ...
        var angle = value
            ...
            : 0;
        return (React.createElement(Hand, { angle: angle, length: minuteHandLength, name: "minute", oppositeLength: minuteHandOppositeLength, width: size / minuteHandWidthRatio, classes: classes === null || classes === void 0 ? void 0 : classes.handle }));
    }
    function renderSecondHandFn() {
        ...
        return (React.createElement(Hand, { angle: angle, length: secondHandLength, name: "second", classes: __assign({ body: clockClasses.secondHand }, classes === null || classes === void 0 ? void 0 : classes.handle), oppositeLength: secondHandOppositeLength, width: size / secondHandWidthRatio }));
    }
